...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TextureDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 30, 0) // ""
    ...
    "TextureDialog\0processBtnEvent\0"
};
...
void *TextureDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextureDialog.stringdata))
